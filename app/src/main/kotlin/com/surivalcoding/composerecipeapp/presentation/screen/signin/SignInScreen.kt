package com.surivalcoding.composerecipeapp.presentation.screen.signin
...
fun NavController.returnToSignIn() {
    navigate(SignInRoute, navOptions = navOptions {
        popBackStack<SignInRoute>(inclusive = true)
//        popUpTo<SignUpRoute> {
//            inclusive = true
//        }
    })
